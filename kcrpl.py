...
if "/" in tag:
    time.sleep(1)
    if tag == "/kcrplobjection" or tag == "/kcrplhmm" or tag == "/kcrplevidence": print("Spectra: <Harambe GIF>")
    elif tag == "/kcrplhaha": print("Spectra: <GIF>")
    else: print("Spectra: <Harambe <GIF>")
